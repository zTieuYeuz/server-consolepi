...
<p><strong>Ve pin - DA BO HAN muc nay (ban 0.4.36):</strong> may nay khong co
pin nao Pi doc duoc, da kiem chung lai bang thuc thi that truoc khi bo:
<code>/sys/class/power_supply</code> RONG, <code>upower</code> khong thay thiet
bi nao, va khong co <code>/dev/i2c-*</code> nao ca (I2C dang tat trong cau hinh
boot). Truoc day giao dien van giu 1 dong "Pin: khong co phan cung bao pin" va
1 muc trong Cai dat de bat doc pin qua I2C - ca hai deu khong bao gio dung toi
tren may nay, chi lam roi giao dien. Neu sau nay gan UPS HAT that, lay lai code
doc pin tu lich su git (truoc ban 0.4.36).</p>
