...
(function () {
  ...
  /* LOI THAT DA GAP (anh Thoai bao ban phim "che hon nua man hinh", gui anh
     chup man hinh khung Console bi ban phim de kin): ban dau dung
     clamp(40px,7.5vh,58px) cho MOI phim - tren man 1280x800 that su cua
     RasPad (da do bang wlr-randr, khong doan) tong chieu cao ca khoi ban
     phim (4 hang chu + 1 hang dieu khien + thanh nhan + le) cong lai xap xi
     396px, tuc GAN 50% chieu cao man hinh - dung y het loi anh Thoai ta.
     Tren trang Console, khung terminal da bi thu hep san
     (calc(100vh - 330px)) de danh cho ban phim, dan toi khi ban phim luon
     mo san (tmuxSession) thi phan con lai cua man hinh con qua it, cam giac
     "che het".
     Da giam manh: 5 hang con lai khoang 230-250px (~30% man hinh) - van
     tren nguong toi thieu 30px/12px chu de con bam trung bang ngon tay,
     nhung khong con nuot mat nua man hinh nua. */
  var css = [
    ...
    'padding:clamp(2px,0.5vh,4px) 6px clamp(3px,0.6vh,5px)!important;display:none;',
    ...
    '#cpvk .cprow{display:flex!important;justify-content:center!important;gap:5px!important;',
    'margin:clamp(2px,0.4vh,4px) 0!important;width:100%!important;}',
    /* Phim chuan rong bang 1/10 man hinh -> hang 10 phim trai kin chieu ngang.
       ...
       hai ben trong tron. */
    '#cpvk .cprow button{flex:0 0 calc((100% - 45px) / 10)!important;',
    'width:auto!important;min-width:0!important;',
    'max-width:none!important;height:clamp(30px,4.6vh,40px)!important;',
    'min-height:30px!important;margin:0!important;',
    'padding:0 3px!important;font-size:clamp(12px,2vh,16px)!important;line-height:1!important;',
    'background:#33383e!important;color:#e9edf2!important;border:1px solid #454b52!important;',
    'border-radius:6px!important;cursor:pointer!important;touch-action:manipulation!important;',
    ...
    '#cpvk .cprow.last button.w{flex:1.4 1 0!important;font-size:clamp(10px,1.6vh,12px)!important;}',
    '#cpvk .cprow.last button.sp{flex:4 1 0!important;font-size:clamp(11px,1.8vh,13px)!important;}',
    '#cpvk button.act{background:#454b52!important;font-size:clamp(9px,1.4vh,11px)!important;}',
    ...
    'align-items:center!important;gap:8px!important;padding:0px 3px 2px!important;',
    'color:#93a0b0!important;font-size:11px!important;}',
    '#cpvk .cpbar b{color:#4CAF50!important;}',
    '#cpvk button.cpclose{background:#d64545!important;color:#fff!important;',
    'min-width:56px!important;height:clamp(22px,3vh,26px)!important;',
    'min-height:22px!important;font-size:11px!important;}',
