...
(function () {
  ...
  var css = [
    ...
    'padding:6px 8px 9px!important;display:none;box-shadow:0 -6px 22px rgba(0,0,0,.7)!important;',
    'font-family:system-ui,Arial,sans-serif!important;}',
    '#cpvk.on{display:block!important;}',
    '#cpvk *{box-sizing:border-box!important;}',
    '#cpvk .cprow{display:flex!important;justify-content:center!important;gap:7px!important;',
    'margin:7px 0!important;width:100%!important;}',
    /* Phim chuan rong bang 1/10 man hinh -> hang 10 phim trai kin chieu ngang.
       ...
       hai ben trong tron. */
    '#cpvk .cprow button{flex:0 0 calc((100% - 63px) / 10)!important;',
    'width:auto!important;min-width:0!important;',
    'max-width:none!important;height:58px!important;min-height:58px!important;margin:0!important;',
    'padding:0 4px!important;font-size:21px!important;line-height:1!important;',
    ...
    '#cpvk .cprow.last button.w{flex:1.4 1 0!important;font-size:15px!important;}',
    '#cpvk .cprow.last button.sp{flex:4 1 0!important;font-size:16px!important;}',
    '#cpvk button.act{background:#454b52!important;font-size:14px!important;}',
    ...
    'min-width:74px!important;height:32px!important;min-height:32px!important;font-size:13px!important;}',
    /* Nut bat/tat noi - luon o goc phai duoi */
    '#cpvktoggle{position:fixed!important;right:14px!important;bottom:14px!important;',
    'z-index:2147482999!important;width:58px!important;height:58px!important;min-width:58px!important;',
    'min-height:58px!important;padding:0!important;border-radius:50%!important;',
